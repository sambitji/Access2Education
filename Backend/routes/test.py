...
def _style_details(style: str) -> dict:
    details = {
        ...
        "practice_based":     {"title":"Practice-Based Learner","description":"Kar ke seekhte ho tum — theory baad mein.","strengths":["Hands-on kaam mein best ho","Problem solving strong hai","Projects mein best perform karte ho"],"content_types":["Coding Exercises","Mini Projects","Hands-on Labs"],"study_tip":"Pehle problem try karo, phir solution dekho!"},
